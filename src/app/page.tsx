    ...
    <>
      ...
      <section className="relative overflow-hidden bg-surface px-4 py-14 sm:px-6 sm:py-20">
        ...
        <div className="relative mx-auto max-w-7xl">
          <Reveal>
            <p className="eyebrow text-center text-gold">Two ways to shop</p>
            <h2 className="mt-3 text-center font-display text-4xl tracking-wide text-royal sm:text-5xl">
              Explore
            </h2>
      ...
      <section className="relative overflow-hidden border-t border-line bg-gold-soft px-4 py-16 sm:px-6 sm:py-20">
        ...
        <Reveal>
          <div className="relative mx-auto max-w-3xl text-center">
            <p className="eyebrow text-gold">Studio visit</p>
            <h2 className="font-display mt-3 text-3xl text-royal sm:text-4xl md:text-5xl">
              Need expert guidance?
            </h2>
            <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed text-ink-muted sm:text-base">
              Book a studio appointment for piercing or styling — or chat with us
              on WhatsApp for metal, size, and placement help.
            </p>
